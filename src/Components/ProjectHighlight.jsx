        ...
        <div className="ProjectHighLight">
            <div className="ph-heading">
                <div className="ph-left">
                    ...
                    Invest in Trusted Quality. Live in Unmatched Comfort
                    </div>
                </div>
            ...
            <div className="ph-content">
                <div className="ph-card ph-card1">
                    <div className="upper-content">01. 2BHK to 4BHK</div>
                ...
                <div className="upper-content">02. ₹50L–₹1.5Cr</div>
                    <div className="lower-content">
                ...
                <div className="upper-content">03. 100–1000 sq yd plots</div>
                    <div className="lower-content">
                        <h3>📏 100–1000 sq. yd. Plots</h3>
                        <p>Build your dream home on expansive plots ranging from 100 to 1000 square yards, offering ample space and flexibility to bring your vision to life.</p>
                    </div>
                </div>
            </div>
        </div>
